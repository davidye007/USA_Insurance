...
selectInput("insur_type", label = "Insurance:",
            choices = c("Direct-purchase", "Employer-based", "Medicaid", "Medicare", "Private", "Public", "TRICARE", "Uninsured", "VA Care"), selected = "Direct-purchase")
```
...
```{r, cache=FALSE}
custom_palette <- c("#0041C2", "#3BB143", "#E31A1C", "#6A3D9A", "#FF7F00", "#964B00", "#ccac00", "#FF0090", "#12086F")
renderPlot({
